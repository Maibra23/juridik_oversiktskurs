...
- En gren har ANTINGEN `"grenar"` ELLER `"lagar"`, aldrig båda/ingetdera
  (`_bygg_gren`, `utils/rattskarta.py:106–110`). Redan testat generiskt av
...
Filen `APPGUIDE.md`, rad ~335–339, innehåller i dag:
...
```
Speciell avtalsrätt rymmer sju avtalstyper (köp- och konsumenträtt, köp
