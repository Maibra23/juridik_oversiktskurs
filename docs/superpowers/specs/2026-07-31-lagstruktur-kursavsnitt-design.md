...
totalt). RB "Väckande av talan och rättegångshinder" anger 13:1–13:15 när bara
13:1–13:7 existerar; KKöpL "Påföljder vid fel" anger 5:1–5:20 mot verkliga 5:1–5:11.
...
**Skriptet rättar aldrig `lagrum.json`.** Om ett avsnitt ska omfatta 13:1–13:7 eller
13:1–13:5 är en bedömning av kursens omfång, inte en textjämförelse. Skriptet
...
KURSAVSNITT                    kursen täcker 6 av lagens 8 kapitel
  1 kap. Grundläggande bestämmelser
     1–9 §§    Lagens tillämpningsområde och tvingande verkan   ↗
  3 kap. Näringsidkarens dröjsmål
     1–6 §§    Påföljder vid säljarens dröjsmål                 ↗
```
...
- Kapitel- och momentlistorna är aldrig båda tomma.
